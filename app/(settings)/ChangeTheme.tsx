...
const ChangeThemeScreen: React.FC = () => {
  ...
  const onConfirm = () => {
    // This function will be called when the user confirms their theme selection
    // You can implement any additional logic here if needed
    console.log("Theme confirmed:", selectedTheme);
    router.back();
  }
    ...
    <LinearGradient colors={['#6F6F6F', '#FFFFFF']} style={{ flex: 1 }}>
      ...
      <View className="mt-16">
        ...
        <View style={styles.header}>
            <Text style={styles.headerText}>Light or dark mode?</Text>
        </View>
